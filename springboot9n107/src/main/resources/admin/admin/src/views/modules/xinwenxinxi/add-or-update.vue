<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="新闻分类" prop="xinwenfenlei">
        ...
        <div v-else>
          <el-form-item class="input" label="新闻分类" prop="xinwenfenlei">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="新闻视频" prop="xinwenshipin">
          <file-upload
          tip="点击上传新闻视频"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xinwenshipin" label="新闻视频" prop="xinwenshipin">
            <el-button type="text" size="small" @click="download(ruleForm.xinwenshipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="素材来源" prop="sucailaiyuan">
          <el-input v-model="ruleForm.sucailaiyuan" 
              placeholder="素材来源" clearable  :readonly="ro.sucailaiyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="素材来源" prop="sucailaiyuan">
              <el-input v-model="ruleForm.sucailaiyuan" 
                placeholder="素材来源" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xinwenshipin = true;
          ...
          if(o=='sucailaiyuan'){
            this.ruleForm.sucailaiyuan = obj[o];
	    this.ro.sucailaiyuan = true;
            continue;
          }
          if(o=='faburiqi'){
	...
	this.ruleForm.xinwenneirong = this.ruleForm.xinwenneirong.replace(reg,'../../../springboot9n107/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	this.ruleForm.xinwenshipin = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
